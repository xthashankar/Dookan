 ...
 */
@Entity
@Table(name = "orders", catalog = "dookan", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Orders.findAll", query = "SELECT o FROM Orders o")
    , @NamedQuery(name = "Orders.findById", query = "SELECT o FROM Orders o WHERE o.id = :id")
    , @NamedQuery(name = "Orders.findByOrderplacedate", query = "SELECT o FROM Orders o WHERE o.orderplacedate = :orderplacedate")
...
public class Orders implements Serializable {
    ...
    public String toString() {
        return "edu.kist.bit.dookan.entity.Orders[ id=" + id + " ]";
    }
