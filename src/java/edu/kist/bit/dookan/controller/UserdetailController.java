...
public class UserdetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       EntityManagerFactory emf = (EntityManagerFactory) request.getServletContext().getAttribute("Dookanemf");                
        UserdetailJpaController userdetailjpa=new UserdetailJpaController (emf);
//        List<Product> product = null
         List<Userdetail> user=userdetailjpa.findUserdetailEntities();
       
        request.setAttribute("users", user);
//        try (PrintWriter printWriter = response.getWriter()) {
//        printWriter.print("Id:"+u.getId());
//        }
        request.getRequestDispatcher("/WEB-INF/admin/userdetail.jsp").forward(request, response);
        }
