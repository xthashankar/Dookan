 ...
 * @author shankar xtha
 */
@WebServlet(name = "AproducteditController", urlPatterns = {"/Aproductedit"})
public class AproducteditController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Product product = productJpa.findProduct(pid);
        request.setAttribute("product", product);
        request.getRequestDispatcher("/WEB-INF/admin/adminproductedit.jsp").forward(request, response);
    }
