...
import static edu.kist.bit.dookan.entity.Product_.id;
import edu.kist.bit.dookan.services.OrdersJpaController;
 ...
 * @author shankar xtha
 */
@WebServlet(name = "AorderController", urlPatterns = {"/Aorder"})
public class AorderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Orders> order=orderJpaController.findOrdersEntities();
