...
import edu.kist.bit.dookan.services.CartJpaController;
...
public class cartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CartJpaController cartJpaController = new CartJpaController(emf);
        List<Cart> cart=cartJpaController.findCartEntities();
